...
class Detr3D(MVXTwoStageDetector):
    ...
    def set_default_img_meta(self):
        img_meta = dict()
        img_meta['ori_shape'] = (1080, 1920, 3, 6)
        img_meta['img_shape'] = [(1088, 1920, 3), (1088, 1920, 3), (1088, 1920, 3), (1088, 1920, 3),
                                 (1088, 1920, 3), (1088, 1920, 3)]
        img_meta['pad_shape'] = [(1088, 1920, 3), (1088, 1920, 3), (1088, 1920, 3), (1088, 1920, 3),
                                 (1088, 1920, 3), (1088, 1920, 3)]
        img_meta['lidar2img'] = None
        self.default_img_meta = img_meta

    def forward_dummy(self, imgs, cams_pose):
        ...
        bboxes = preds_dicts[0]['bboxes']
        scores = preds_dicts[0]['scores']
        labels = preds_dicts[0]['labels']
