...
class Detr3DCrossAtten(BaseModule):
    ...
    def forward(self,
        ...
        # output = torch.nan_to_num(output) # temp remove by ryan.qc
...
def feature_sampling(mlvl_feats, reference_points, pc_range, img_metas):
    if isinstance(img_metas[0]['lidar2img'], list):  # modify by ryan.qc
        lidar2img = []
        ...
        lidar2img = img_metas[0]['lidar2img']  # only support 1 batch inference after exp
    ...
    reference_points_cam = reference_points_cam[..., 0:2] / reference_points_cam[..., 2:3]  # replace by ryan.qc
